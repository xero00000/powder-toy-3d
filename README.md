...
- GPU-instanced rendering, ACES tone mapping, thermal lighting, procedural ambience, camera shake, chamber fog, and a cinematic lab interface. The default clarity view uses a color-faithful 165% exposure, contrast-preserving dark-material lift and an enabled section cut, keeping every distinct upstream RGB value visually distinct; bloom remains available in the cinematic and effects views.
